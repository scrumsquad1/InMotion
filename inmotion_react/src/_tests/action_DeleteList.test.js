...
import {TYPE_LISTS_DELETELIST_COMPLETE} from '../_redux/actions/lists/action_DeleteList';

it('action_DeleteList works as expected', () => {
    ...
    store.dispatch({type: TYPE_LISTS_DELETELIST_COMPLETE, payload: newList});
    expect(store.getState().listsStore.lists.indexOf(newList) > -1).toBe(false);
